...
| Lost updates between writers | Explicit last-successful-replacement-wins contract; Windows privately serializes same-process same-target contexts | Thread and multiprocess stress tests; README and architecture | The Windows mechanism does not coordinate processes or provide compare-and-swap or transaction isolation. |
